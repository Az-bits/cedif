                                                    ...
                                                    <div class="col-md-12 text-center">
                                                        <div class="fileinput fileinput-new text-center"
                                                            ...
                                                            <div class="fileinput-new thumbnail img-raised">
                                                                ...
                                                                <img src="{{ $sala->image }}" id="preViewImage"
                                                                    rel="nofollow" alt="...">
                                                            </div>
                                                            <div
                                        ...
                                        <div class="col-lg-6">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 mt-3">
                                                    ...
                                                    <textarea name="subtitulo" id="subtitulo" cols="30" rows="5" class="form-control">{{ old('subtitulo', $sala->subtitulo) }}</textarea>
                                                </div>
                                                <div class="col-lg-12 mt-3">
                                                    <label for="descripcion">Descripción </label>
                                                    <textarea name="descripcion" id="descripcion" cols="30" rows="5" class="form-control">{{ old('descripcion', $sala->descripcion) }}</textarea>
                                                </div>
                                                <div class="col-lg-12 mt-3">
                                                    <label for="cupo">Cupos</label>
                                                    <input type="number" id="cupo" name="cupo" class="form-control"
                                                        placeholder="Cupos de la sala"
                                                        value="{{ old('cupo', $sala->cupo) }}" min="0">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
