            ...
            <div class="col-lg-12">
                <div class="card ">
                    <div class="card-header card-header-rose card-header-icon">
                        ...
                        <h4 class="card-title">Nueva imagen en Galeria</h4>
                    </div>
                    <div class="card-body ">
                        <form id="formulario_modal" method="post" action="{{ route('admin-galerias.store') }}"
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <input type="text" id="titulo" name="titulo" class="form-control"
                                                        placeholder="Titulo de la imagen" value="{{ old('titulo') }}">
                                                </div>
