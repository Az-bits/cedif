        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card ">
                    ...
                    <div class="card-body ">
                        <form id="formulario_modal" method="post" action="{{ route('admin-contacto.store') }}">
                            @csrf
                                ...
                                <div class="col-12 mt-2">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-10">
                                            ...
                                            <textarea name="descripcion" id="descripcion" class="form-control" cols="30" rows="5">{{ old('descripcion') }}</textarea>
                                        </div>
                                        <div class="col-lg-2">
                                            <div class="form-group">
