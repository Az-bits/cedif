                                        ...
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="paterno" name="paterno" class="form-control"
                                                    value="{{ old('paterno', $persona->paterno) }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="materno" name="materno" class="form-control"
                                                    value="{{ old('materno', $persona->materno) }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <select class="selectpicker" data-style="btn btn-primary btn-round"
                                                    ...
                                                    <option
                                                        {{ old('expedido', $persona ? $persona->expedido : '') == 'LP' ? 'selected' : '' }}
                                                        value="LP">La Paz</option>
                                                    <option
                                                        {{ old('expedido', $persona->expedido) == 'CBBA' ? 'selected' : '' }}
                                                        value="CBBA">Cochabamba</option>
                                                    <option
                                                        {{ old('expedido', $persona->expedido) == 'SC' ? 'selected' : '' }}
                                                        value="SC">Santa Cruz</option>
                                                    <option
                                                        {{ old('expedido', $persona->expedido) == 'OR' ? 'selected' : '' }}
                                                        value="OR">Oruro</option>
                                                    <option
                                                        {{ old('expedido', $persona->expedido) == 'PT' ? 'selected' : '' }}
                                                        value="PT">Potosí</option>
                                                    <option
                                                        {{ old('expedido', $persona->expedido) == 'CH' ? 'selected' : '' }}
                                                        value="CH">Chuquisaca</option>
                                                    <option
                                                        {{ old('expedido', $persona->expedido) == 'TJ' ? 'selected' : '' }}
                                                        value="TJ">Tarija</option>
                                                    <option
                                                        {{ old('expedido', $persona->expedido) == 'PA' ? 'selected' : '' }}
                                                        value="PA">Pando</option>
                                                    <option
                                                        {{ old('expedido', $persona->expedido) == 'BN' ? 'selected' : '' }}
                                                        value="BN">Beni</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="email" id="email" name="email" class="form-control"
                                                    placeholder="correo" value="{{ old('email', $persona->email) }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
