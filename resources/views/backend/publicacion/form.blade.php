                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 mt-2">
                        <div class="form-group">
                            ...
                            <input type="text" id="titulo" name="titulo" class="form-control datepicker"
                                placeholder="Nombre de la publicación">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="tipo">Tipo de publicación <span class="az-r">( * )</span></label><br>
                    ...
                    <div class="col-lg-12 mt-2">
                        <div class="form-group">
                            ...
                            <input type="text" id="direccion" name="direccion" class="form-control datepicker"
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="date" id="f_i" name="fecha_ini" class="form-control datepicker"
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="date" id="f_f" name="fecha_fin" class="form-control datepicker"
                                placeholder="mm-dd-aaaa">
                        </div>
                    </div>
                    <div class="col-lg-4">
                            ...
                            <div class="form-check">
                                <div class="form-group">
                                    <label class="form-check-label">
                                        Publicar <input name="estado" class="form-check-input" type="checkbox"
                                            value="1">
